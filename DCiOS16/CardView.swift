    ...
    var card: some View {
        VStack(spacing: 12) {
            Image(systemName: "aspectratio")
                ...
                .foregroundStyle(.linearGradient(Gradient(colors: [.white, .clear]), startPoint: .topLeading, endPoint: .bottomTrailing))
                .background(
                    HexagonShape()
                        .stroke()
                        .foregroundStyle(.linearGradient(Gradient(colors: [.white.opacity(0.5), .clear]), startPoint: .topLeading, endPoint: .bottomTrailing))
                )
                .background(
                    HexagonShape()
                        .foregroundStyle(.linearGradient(Gradient(colors: [.clear, .white.opacity(0.3)]), startPoint: .topLeading, endPoint: .bottomTrailing))
                )
